...
export default function AccessManagement() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Secondary Menu Header Starts (Grid | Table | Add Application) */}

        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-2">
            <Button
              variant={viewMode === "grid" ? "default" : "outline"} size="sm" onClick={() => setViewMode("grid")}>
              <Grid className="w-4 h-4 mr-2" />
              Grid
            </Button>
            <Button
              variant={viewMode === "table" ? "default" : "outline"} size="sm" onClick={() => setViewMode("table")}>
      ...
      {/* Secondary Menu Header ENDS (Grid | Table | Add Application) */}

      {/* Applications View (Main Content) STARTS */}

        {viewMode === "grid" ? (
          
          // Application View in GRID STARTS
          ...
          // Application View in GRID ENDS

          ):(    

          // Application View in TABLE (non-grid) STARTS
          ...
          // Application View in TABLE (non-grid) ENDS
          
          )
        }
      {/* Applications View (Main Content) ENDS */}


      {/* User Management Dialog STARTS */}
      ...
      {/* Application Settings Dialog STARTS */}
      ...
      {/* Application Settings Dialog ENDS */}
